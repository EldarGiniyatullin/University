...
//    lineEditOutput();
    ...
    connect(ui->spinBox, SIGNAL(valueChanged(int)), ui->lineEdit, SLOT(lineEditOutput()));
    connect(ui->comboBox, SIGNAL(activated(int)), ui->lineEdit, SLOT(lineEditOutput()));
    connect(ui->spinBox_2, SIGNAL(valueChanged(int)), ui->lineEdit, SLOT(lineEditOutput()));
